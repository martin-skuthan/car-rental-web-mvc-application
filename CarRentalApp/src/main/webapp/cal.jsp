...
<input id="date" name="date" type="text" class="form-control" placeholder="MM/DD/YYY" required><br>
<label>End date:</label>  
<input id="date" name="date" type="text" class="form-control" placeholder="MM/DD/YYY" required><br>  
<button style="width:49%" class="btn btn-lg btn-secondary btn-inline-block" name="itemToDelete" type="submit">Cancel</button>
<button style="width:49%" class="btn btn-lg btn-primary btn-inline-block" name="itemToDelete" value="${param.idOfItemToDelete}" type="submit">Confirm</button>
</form>
</div>
</div>
</div>     
